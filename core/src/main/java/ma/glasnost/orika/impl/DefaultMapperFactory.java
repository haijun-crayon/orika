...
public class DefaultMapperFactory implements MapperFactory, Reportable {
    ...
    private ClassMapChecker classMapChecker;

    public void registerClassMapChecker(ClassMapChecker classMapChecker){
        this.classMapChecker = classMapChecker;
    }
    /**
    ...
    private GeneratedMapperBase buildMapper(ClassMap<?, ?> classMap, boolean isAutoGenerated, MappingContext context) {
        if (null != classMapChecker) {
            classMapChecker.check(classMap);
        }
